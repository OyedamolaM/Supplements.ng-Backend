...
exports.getSupplierInvoices = async (req, res) => {
    try {
        ...
        if (status)
            where.status = toDbInvoiceStatus(status);
...
exports.updateSupplierInvoice = async (req, res) => {
    try {
        ...
        const nextDueDate = updateData.dueDate !== undefined ? updateData.dueDate : invoice.dueDate;
        updateData.status = toDbInvoiceStatus(computeStatus(invoice.balance, nextDueDate, invoice.amountPaid));
