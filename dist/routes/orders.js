...
const { createOrder, getMyOrders, getOrderById, getReceipt, cancelOrder, rateOrder, trackDelivery, getShippingQuote, getDeliveryTimeEstimate, getShippingStates, getLockersByState, checkLockerAvailability, getExportLocations, getExportDeliveryCost, confirmDelivery, } = require('../controllers/orderController');
